...
Private Sub B4XPage_Appear
	UDPSocket1.Initialize("UDP", Main.Listen_port, 255)
...
Private Sub Send_UDP_Data
	...
	Packet1.Initialize(data, Main.Remote_ip, Main.Remote_port)
